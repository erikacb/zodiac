...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { category: @sentence.category, content: @sentence.content, language: @sentence.language } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { category: @sentence.category, content: @sentence.content, language: @sentence.language } }
